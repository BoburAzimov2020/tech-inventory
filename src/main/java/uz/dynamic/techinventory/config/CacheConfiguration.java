...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, uz.dynamic.techinventory.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, uz.dynamic.techinventory.repository.UserRepository.USERS_BY_EMAIL_CACHE);

...
public class CameraTypeResource {
     ...
     */
    @PostMapping("")
    public ResponseEntity<CameraTypeDTO> createCameraType(
            @Valid @RequestBody CameraTypeDTO cameraTypeDTO) throws URISyntaxException {

...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './swich.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SWICH_LIST actions', async () => {
    ...
    it('dispatches FETCH_SWICH actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SWICH actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SWICH actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SWICH actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SWICH actions', async () => {
      const expectedActions = [
        {

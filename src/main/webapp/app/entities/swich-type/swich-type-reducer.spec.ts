...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SWICHTYPE_LIST actions', async () => {
    ...
    it('dispatches FETCH_SWICHTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SWICHTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SWICHTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SWICHTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SWICHTYPE actions', async () => {
      const expectedActions = [
        {

...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './stoyka.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STOYKA_LIST actions', async () => {
    ...
    it('dispatches FETCH_STOYKA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_STOYKA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_STOYKA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_STOYKA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_STOYKA actions', async () => {
      const expectedActions = [
        {

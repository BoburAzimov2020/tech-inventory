...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TERMINALSERVER_LIST actions', async () => {
    ...
    it('dispatches FETCH_TERMINALSERVER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TERMINALSERVER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TERMINALSERVER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TERMINALSERVER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TERMINALSERVER actions', async () => {
      const expectedActions = [
        {

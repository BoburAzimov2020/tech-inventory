...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './ups.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_UPS_LIST actions', async () => {
    ...
    it('dispatches FETCH_UPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_UPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_UPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_UPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_UPS actions', async () => {
      const expectedActions = [
        {

...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CAMERATYPE_LIST actions', async () => {
    ...
    it('dispatches FETCH_CAMERATYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CAMERATYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CAMERATYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CAMERATYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CAMERATYPE actions', async () => {
      const expectedActions = [
        {

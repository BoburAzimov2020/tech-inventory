...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CABELTYPE_LIST actions', async () => {
    ...
    it('dispatches FETCH_CABELTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CABELTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CABELTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CABELTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CABELTYPE actions', async () => {
      const expectedActions = [
        {

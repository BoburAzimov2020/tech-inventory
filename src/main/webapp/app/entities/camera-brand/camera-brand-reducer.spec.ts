...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CAMERABRAND_LIST actions', async () => {
    ...
    it('dispatches FETCH_CAMERABRAND actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CAMERABRAND actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CAMERABRAND actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CAMERABRAND actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CAMERABRAND actions', async () => {
      const expectedActions = [
        {

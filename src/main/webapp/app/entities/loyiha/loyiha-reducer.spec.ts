...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './loyiha.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LOYIHA_LIST actions', async () => {
    ...
    it('dispatches FETCH_LOYIHA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LOYIHA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LOYIHA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LOYIHA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LOYIHA actions', async () => {
      const expectedActions = [
        {

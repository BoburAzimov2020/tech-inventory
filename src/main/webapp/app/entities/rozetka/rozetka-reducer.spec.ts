...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './rozetka.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ROZETKA_LIST actions', async () => {
    ...
    it('dispatches FETCH_ROZETKA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ROZETKA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ROZETKA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ROZETKA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ROZETKA actions', async () => {
      const expectedActions = [
        {

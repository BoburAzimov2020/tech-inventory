...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './projector.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROJECTOR_LIST actions', async () => {
    ...
    it('dispatches FETCH_PROJECTOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PROJECTOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PROJECTOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PROJECTOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PROJECTOR actions', async () => {
      const expectedActions = [
        {

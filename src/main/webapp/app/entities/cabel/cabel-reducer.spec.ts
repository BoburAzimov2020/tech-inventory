...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './cabel.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CABEL_LIST actions', async () => {
    ...
    it('dispatches FETCH_CABEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CABEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CABEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CABEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CABEL actions', async () => {
      const expectedActions = [
        {

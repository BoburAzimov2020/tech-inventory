...
export const DistrictUpdate = () => {
  ...
  const defaultValues = () =>
    isNew
      ...
      : {
          ...districtEntity,
          region: districtEntity?.region?.id,
        };
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="techInventoryApp.district.home.createOrEditLabel" data-cy="DistrictCreateUpdateHeading">
            Создать или отредактировать District
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              />
              <ValidatedField id="district-region" name="region" data-cy="region" label="Region" type="select">
                <option value="" key="0" />
                {regions

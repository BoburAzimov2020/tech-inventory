...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROJECTORTYPE_LIST actions', async () => {
    ...
    it('dispatches FETCH_PROJECTORTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PROJECTORTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PROJECTORTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PROJECTORTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PROJECTORTYPE actions', async () => {
      const expectedActions = [
        {

...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SHELFTYPE_LIST actions', async () => {
    ...
    it('dispatches FETCH_SHELFTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SHELFTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SHELFTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SHELFTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SHELFTYPE actions', async () => {
      const expectedActions = [
        {

...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AKUMULATOR_LIST actions', async () => {
    ...
    it('dispatches FETCH_AKUMULATOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_AKUMULATOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_AKUMULATOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_AKUMULATOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_AKUMULATOR actions', async () => {
      const expectedActions = [
        {

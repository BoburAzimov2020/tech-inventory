...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OBJECTTASNIFI_LIST actions', async () => {
    ...
    it('dispatches FETCH_OBJECTTASNIFI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_OBJECTTASNIFI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_OBJECTTASNIFI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_OBJECTTASNIFI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_OBJECTTASNIFI actions', async () => {
      const expectedActions = [
        {

...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './svitafor-detector.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SVITAFORDETECTOR_LIST actions', async () => {
    ...
    it('dispatches FETCH_SVITAFORDETECTOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SVITAFORDETECTOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SVITAFORDETECTOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SVITAFORDETECTOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SVITAFORDETECTOR actions', async () => {
      const expectedActions = [
        {

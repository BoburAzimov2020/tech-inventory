...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STOYKATYPE_LIST actions', async () => {
    ...
    it('dispatches FETCH_STOYKATYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_STOYKATYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_STOYKATYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_STOYKATYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_STOYKATYPE actions', async () => {
      const expectedActions = [
        {

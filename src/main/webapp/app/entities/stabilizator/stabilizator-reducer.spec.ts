...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STABILIZATOR_LIST actions', async () => {
    ...
    it('dispatches FETCH_STABILIZATOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_STABILIZATOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_STABILIZATOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_STABILIZATOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_STABILIZATOR actions', async () => {
      const expectedActions = [
        {

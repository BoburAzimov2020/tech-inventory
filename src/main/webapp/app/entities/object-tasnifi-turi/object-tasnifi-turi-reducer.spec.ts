...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './object-tasnifi-turi.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OBJECTTASNIFITURI_LIST actions', async () => {
    ...
    it('dispatches FETCH_OBJECTTASNIFITURI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_OBJECTTASNIFITURI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_OBJECTTASNIFITURI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_OBJECTTASNIFITURI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_OBJECTTASNIFITURI actions', async () => {
      const expectedActions = [
        {

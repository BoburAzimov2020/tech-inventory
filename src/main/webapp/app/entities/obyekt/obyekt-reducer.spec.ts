...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './obyekt.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OBYEKT_LIST actions', async () => {
    ...
    it('dispatches FETCH_OBYEKT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_OBYEKT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_OBYEKT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_OBYEKT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_OBYEKT actions', async () => {
      const expectedActions = [
        {

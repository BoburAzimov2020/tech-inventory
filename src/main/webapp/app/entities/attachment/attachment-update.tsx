...
export const AttachmentUpdate = () => {
  ...
  const defaultValues = () =>
    isNew
      ...
      : {
          ...attachmentEntity,
          obyekt: attachmentEntity?.obyekt?.id,
        };
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="techInventoryApp.attachment.home.createOrEditLabel" data-cy="AttachmentCreateUpdateHeading">
            Создать или отредактировать Attachment
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              />
              <ValidatedField id="attachment-obyekt" name="obyekt" data-cy="obyekt" label="Obyekt" type="select">
                <option value="" key="0" />
                {obyekts

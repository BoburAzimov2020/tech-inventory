    ...
    <div>
      ...
      <div className="table-responsive">
        {attachmentList && attachmentList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('originalFileName')}>
                  Original File Name <FontAwesomeIcon icon={getSortIconByFieldName('originalFileName')} />
                </th>
            ...
            <tbody>
              {attachmentList.map((attachment, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{attachment.obyekt ? <Link to={`/obyekt/${attachment.obyekt.id}`}>{attachment.obyekt.id}</Link> : ''}</td>
          ...
          !loading && <div className="alert alert-warning">Attachments не найдено</div>
        )}
      </div>
      {totalItems ? (

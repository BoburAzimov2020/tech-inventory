...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BUYURTMARAQAM_LIST actions', async () => {
    ...
    it('dispatches FETCH_BUYURTMARAQAM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BUYURTMARAQAM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BUYURTMARAQAM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BUYURTMARAQAM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BUYURTMARAQAM actions', async () => {
      const expectedActions = [
        {

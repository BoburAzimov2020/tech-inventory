...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './avtomat.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AVTOMAT_LIST actions', async () => {
    ...
    it('dispatches FETCH_AVTOMAT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_AVTOMAT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_AVTOMAT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_AVTOMAT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_AVTOMAT actions', async () => {
      const expectedActions = [
        {

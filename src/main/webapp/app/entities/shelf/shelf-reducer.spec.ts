...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './shelf.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SHELF_LIST actions', async () => {
    ...
    it('dispatches FETCH_SHELF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SHELF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SHELF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SHELF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SHELF actions', async () => {
      const expectedActions = [
        {
